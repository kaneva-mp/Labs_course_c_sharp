...
{
    /// <summary>
    /// Конфигурация для файла .html
    /// </summary>
    public class ConfigHTML: LanguageConfig
    {
        /// <summary>
        /// Язык
        /// </summary>
        ...
        public ConfigHTML(string language,
